    ...
    \item[1.]
        \begin{itemize}
            ...
            \item[vi)]
                ...
                \includegraphics[width=9cm]{hw4/pr1_vi_hist_a}
                \includegraphics[width=9cm]{hw4/pr1_vi_hist_b} \\
                \includegraphics[width=9cm]{hw4/pr1_vi_hist_c} \\
            ...
            \item[vii)] I repeated the same procedure as above, but this time caclulated the pFDR. The results are below:
                \includegraphics[width=9cm]{hw4/pr1_vii_hist_a}
                \includegraphics[width=9cm]{hw4/pr1_vii_hist_b} \\
                \includegraphics[width=9cm]{hw4/pr1_vii_hist_c} \\
