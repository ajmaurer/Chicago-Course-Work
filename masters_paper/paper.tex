...
\section{Issues With Deterministic Knockoffs} 
    ...
    \begin{figure}[h]
        \begin{center}
        \includegraphics[width=15cm]{images/entryrate_original_logit}
    \end{center}
